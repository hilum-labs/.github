...
| [`local-llm-web`](https://github.com/hilum-labs/local-llm-web) | Web SDK for WebGPU LLM inference |
...
- Expand the `local-llm` package family across Node.js, web, and React Native.
